from sqlalchemy import (
    Column, String, Boolean, DateTime, Date, ForeignKey, Integer, func
)
...
class Click(Base):
    ...
    clicked_at = Column(Date, nullable=False, default=func.current_date())
    country = Column(String(2), default="unknown")
